...
<link rel="stylesheet" href="<?php echo run_replace('head_css_url', G5_THEME_CSS_URL.'/'.(G5_IS_MOBILE ? 'mobile' : 'default').'.css?ver='.G5_TIME_YMDHIS, G5_THEME_URL); ?>">
<!--[if lte IE 8]>
...
add_javascript('<script src="'.G5_THEME_JS_URL.'/dans.menu.js?ver='.G5_JS_VER.'"></script>', 0);
add_javascript('<script src="'.G5_THEME_JS_URL.'/waypoints.min.js"></script>',0);
