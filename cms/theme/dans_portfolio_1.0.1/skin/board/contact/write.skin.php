...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css?'.G5_TIME_YMDHIS.'">', 0);
?>
...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div">
	    <?php if ($is_name) { ?>
	        ...
	        <input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input half_input required" placeholder="성함(직책)">
	    <?php } ?>
